...
function agruparPorFactura(deliveries: DeliveryRecord[]): FacturaAgrupada[] {
  ...
  deliveries.forEach((d) => {
    ...
    const tiendaKey = d.tienda || "sin-tienda"
...
export default function IVOOHistorialClientePage() {
    ...
    <div className="p-4 lg:p-6 space-y-6">
      <div>
        <h1 className="text-2xl font-bold">
          <span className="text-primary">IVOO APP</span> - Historial de Cliente
        </h1>
