...
export default function ConfiguracionPage() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      setUseDemoData(localStorage.getItem("use_demo_data") === "true")
    }
  }, [])
  ...
  const handleRefresh = async () => {
    ...
    if (useDemoData) params.set("demo", "true")
  ...
  const handleSaveConfig = async () => {
    ...
    try {
      if (typeof window !== "undefined") {
        ...
        localStorage.setItem("use_demo_data", useDemoData.toString())
      }
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      className="h-4 w-4 text-primary-foreground focus:ring-pointer"
                    />
                    <label htmlFor="use-demo-data" className="text-sm font-medium text-muted-foreground">
                      Usar datos de demostración
                    </label>
                  </div>
                  <span className="text-xs text-muted-foreground">
                    Ignorar configuración de Google Sheets y usar siempre datos mock
                  </span>
                </div>
              </div>
              <Button
